...
<div id="content">
    ...
    <div class="breadcrumbs-wrap type-2" data-bg="{{URL::asset('depan/images/dppa-biru.jpg')}}">
        ...
        <div class="container">
            ...
            <h1 class="page-title">{{$berita->nama_menu}}</h1>

            <ul class="breadcrumbs">

                <li><a href="index.html">Beranda</a></li>
                <li><a href="news_big.html">Berita</a></li>
                <li>{{$berita->nama_menu}}</li>
                                    ...
                                    <div class="welcome-content">
                                        ...
                                        <div class="entry">
                                            ...
                                            <div class="entry-meta">
                                                ...
                                                <a href="#" class="entry-calendar">{{$berita->created_at->format('d-m-Y')}}</a>
                                ...
                                <article class="entry">
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="entry-meta">
                                            ...
                                            <time class="entry-date" datetime="2016-01-27">{{$pn->created_at->format('d-m-Y')}}</time>
                                        </div>
